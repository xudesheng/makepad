...
pub const OPEN_TYPE_LANGUAGES: &[LangTag] = &[
    LangTag {
        language: "aa",
        tag: Tag::from_bytes(b"AFR "),
    }, // Afar
    LangTag {
        language: "aae",
        tag: Tag::from_bytes(b"SQI "),
    }, // Arbëreshë Albanian -> Albanian
    LangTag {
        language: "aao",
        tag: Tag::from_bytes(b"ARA "),
    }, // Algerian Saharan Arabic -> Arabic
    LangTag {
        language: "aat",
        tag: Tag::from_bytes(b"SQI "),
    }, // Arvanitika Albanian -> Albanian
    LangTag {
        language: "ab",
        tag: Tag::from_bytes(b"ABK "),
    }, // Abkhazian
    LangTag {
        language: "abh",
        tag: Tag::from_bytes(b"ARA "),
    }, // Tajiki Arabic -> Arabic
    LangTag {
        language: "abq",
        tag: Tag::from_bytes(b"ABA "),
    }, // Abaza
    LangTag {
        language: "abv",
        tag: Tag::from_bytes(b"ARA "),
    }, // Baharna Arabic -> Arabic
    LangTag {
        language: "acf",
        tag: Tag::from_bytes(b"FAN "),
    }, // Saint Lucian Creole French -> French Antillean
    ...
    LangTag {
        language: "acy",
        tag: Tag::from_bytes(b"ARA "),
    }, // Cypriot Arabic -> Arabic
    LangTag {
        language: "ada",
        tag: Tag::from_bytes(b"DNG "),
    }, // Adangme -> Dangme
    LangTag {
        language: "adf",
        tag: Tag::from_bytes(b"ARA "),
    }, // Dhofari Arabic -> Arabic
    LangTag {
        language: "adp",
        tag: Tag::from_bytes(b"DZN "),
    }, // Adap(retired code) -> Dzongkha
    ...
    LangTag {
        language: "ahg",
        tag: Tag::from_bytes(b"AGW "),
    }, // Qimant -> Agaw
    LangTag {
        language: "aht",
        tag: Tag::from_bytes(b"ATH "),
    }, // Ahtena -> Athapaskan
    LangTag {
        language: "aii",
        tag: Tag::from_bytes(b"SWA "),
    }, // Assyrian Neo-Aramaic -> Swadaya Aramaic
    LangTag {
        language: "aii",
        tag: Tag::from_bytes(b"SYR "),
    }, // Assyrian Neo-Aramaic -> Syriac
    //  LangTag { language: "aio", 	tag: Tag::from_bytes(b"AIO ") }, // Aiton
    LangTag {
        language: "aiw",
        tag: Tag::from_bytes(b"ARI "),
    }, // Aari
    LangTag {
        language: "ajp",
        tag: Tag::from_bytes(b"ARA "),
    ...
    LangTag {
        language: "ak",
        tag: Tag::from_bytes(b"AKA "),
    }, // Akan [macrolanguage]
    LangTag {
        language: "ak",
        tag: Tag::from_bytes(b"TWI "),
    }, // Akan [macrolanguage] -> Twi
    LangTag {
        language: "aln",
        tag: Tag::from_bytes(b"SQI "),
    ...
    LangTag {
        language: "am",
        tag: Tag::from_bytes(b"AMH "),
    }, // Amharic
    LangTag {
        language: "amf",
        tag: Tag::from_bytes(b"HBN "),
    }, // Hamer-Banna -> Hammer-Banna
    LangTag {
        language: "amw",
        tag: Tag::from_bytes(b"SYR "),
    }, // Western Neo-Aramaic -> Syriac
    LangTag {
        language: "an",
        tag: Tag::from_bytes(b"ARG "),
    }, // Aragonese
    ...
    LangTag {
        language: "apj",
        tag: Tag::from_bytes(b"ATH "),
    }, // Jicarilla Apache -> Athapaskan
    LangTag {
        language: "apk",
        tag: Tag::from_bytes(b"ATH "),
    }, // Kiowa Apache -> Athapaskan
    LangTag {
        language: "apl",
        tag: Tag::from_bytes(b"ATH "),
    ...
    LangTag {
        language: "apm",
        tag: Tag::from_bytes(b"ATH "),
    }, // Mescalero-Chiricahua Apache -> Athapaskan
    LangTag {
        language: "apw",
        tag: Tag::from_bytes(b"ATH "),
    }, // Western Apache -> Athapaskan
    LangTag {
        language: "ar",
        tag: Tag::from_bytes(b"ARA "),
    ...
    LangTag {
        language: "atj",
        tag: Tag::from_bytes(b"RCR "),
    }, // Atikamekw -> R-Cree
    LangTag {
        language: "atv",
        tag: Tag::from_bytes(b"ALT "),
    }, // Northern Altai -> Altai
    LangTag {
        language: "auz",
        tag: Tag::from_bytes(b"ARA "),
    }, // Uzbeki Arabic -> Arabic
    LangTag {
        language: "av",
        tag: Tag::from_bytes(b"AVR "),
    }, // Avaric -> Avar
    LangTag {
        language: "avl",
        tag: Tag::from_bytes(b"ARA "),
    }, // Eastern Egyptian Bedawi Arabic -> Arabic
    //  LangTag { language: "awa", 	tag: Tag::from_bytes(b"AWA ") }, // Awadhi
    LangTag {
        language: "ay",
        tag: Tag::from_bytes(b"AYM "),
    }, // Aymara [macrolanguage]
    LangTag {
        language: "ayc",
        tag: Tag::from_bytes(b"AYM "),
    }, // Southern Aymara -> Aymara
    LangTag {
        language: "ayh",
        tag: Tag::from_bytes(b"ARA "),
    ...
    LangTag {
        language: "ba",
        tag: Tag::from_bytes(b"BSH "),
    }, // Bashkir
    LangTag {
        language: "bad",
        tag: Tag::from_bytes(b"BAD0"),
    }, // Banda  [family]
    LangTag {
        language: "bai",
        tag: Tag::from_bytes(b"BML "),
    }, // Bamileke  [family]
    LangTag {
        language: "bal",
        tag: Tag::from_bytes(b"BLI "),
    ...
    LangTag {
        language: "bbz",
        tag: Tag::from_bytes(b"ARA "),
    }, // Babalia Creole Arabic -> Arabic
    LangTag {
        language: "bcc",
        tag: Tag::from_bytes(b"BLI "),
    }, // Southern Balochi -> Baluchi
    LangTag {
        language: "bci",
        tag: Tag::from_bytes(b"BAU "),
    }, // Baoulé -> Baulé
    LangTag {
        language: "bcl",
        tag: Tag::from_bytes(b"BIK "),
    }, // Central Bikol -> Bikol
    LangTag {
        language: "bcq",
        tag: Tag::from_bytes(b"BCH "),
    }, // Bench
    LangTag {
        language: "bcr",
        tag: Tag::from_bytes(b"ATH "),
    ...
    LangTag {
        language: "ber",
        tag: Tag::from_bytes(b"BBR "),
    }, // Berber  [family]
    LangTag {
        language: "bfq",
        tag: Tag::from_bytes(b"BAD "),
    }, // Badaga
    LangTag {
        language: "bft",
        tag: Tag::from_bytes(b"BLT "),
    }, // Balti
    LangTag {
        language: "bfu",
        tag: Tag::from_bytes(b"LAH "),
    }, // Gahri -> Lahuli
    LangTag {
        language: "bfy",
        tag: Tag::from_bytes(b"BAG "),
    }, // Bagheli -> Baghelkhandi
    LangTag {
        language: "bg",
        tag: Tag::from_bytes(b"BGR "),
    }, // Bulgarian
    //  LangTag { language: "bgc", 	tag: Tag::from_bytes(b"BGC ") }, // Haryanvi
    LangTag {
        language: "bgn",
        tag: Tag::from_bytes(b"BLI "),
    }, // Western Balochi -> Baluchi
    LangTag {
        language: "bgp",
        tag: Tag::from_bytes(b"BLI "),
    }, // Eastern Balochi -> Baluchi
    //  LangTag { language: "bgq", 	tag: Tag::from_bytes(b"BGQ ") }, // Bagri
    LangTag {
        language: "bgr",
        tag: Tag::from_bytes(b"QIN "),
    }, // Bawm Chin -> Chin
    LangTag {
        language: "bhb",
        tag: Tag::from_bytes(b"BHI "),
    }, // Bhili
    //  LangTag { language: "bhi", 	tag: Tag::from_bytes(b"BHI ") }, // Bhilali -> Bhili
    LangTag {
        language: "bhk",
        tag: Tag::from_bytes(b"BIK "),
    }, // Albay Bicolano(retired code) -> Bikol
    //  LangTag { language: "bho", 	tag: Tag::from_bytes(b"BHO ") }, // Bhojpuri
    LangTag {
        language: "bhr",
        tag: Tag::from_bytes(b"MLG "),
    }, // Bara Malagasy -> Malagasy
    LangTag {
        language: "bi",
        tag: Tag::from_bytes(b"BIS "),
    }, // Bislama
    //  LangTag { language: "bik", 	tag: Tag::from_bytes(b"BIK ") }, // Bikol [macrolanguage]
    LangTag {
        language: "bin",
        tag: Tag::from_bytes(b"EDO "),
    }, // Edo
    //  LangTag { language: "bjj", 	tag: Tag::from_bytes(b"BJJ ") }, // Kanauji
    LangTag {
        language: "bjn",
        tag: Tag::from_bytes(b"MLY "),
    }, // Banjar -> Malay
    LangTag {
        language: "bjq",
        tag: Tag::from_bytes(b"MLG "),
    }, // Southern Betsimisaraka Malagasy(retired code) -> Malagasy
    LangTag {
        language: "bjt",
        tag: Tag::from_bytes(b"BLN "),
    }, // Balanta-Ganja -> Balante
    LangTag {
        language: "bla",
        tag: Tag::from_bytes(b"BKF "),
    }, // Siksika -> Blackfoot
    LangTag {
        language: "ble",
        tag: Tag::from_bytes(b"BLN "),
    }, // Balanta-Kentohe -> Balante
    //  LangTag { language: "blk", 	tag: Tag::from_bytes(b"BLK ") }, // Pa’o Karen
    LangTag {
        language: "bln",
        tag: Tag::from_bytes(b"BIK "),
    }, // Southern Catanduanes Bikol -> Bikol
    LangTag {
        language: "bm",
        tag: Tag::from_bytes(b"BMB "),
    }, // Bambara (Bamanankan)
    LangTag {
        language: "bmm",
        tag: Tag::from_bytes(b"MLG "),
    }, // Northern Betsimisaraka Malagasy -> Malagasy
    LangTag {
        language: "bn",
        tag: Tag::from_bytes(b"BEN "),
    }, // Bengali
    LangTag {
        language: "bo",
        tag: Tag::from_bytes(b"TIB "),
    }, // Tibetan
    //  LangTag { language: "bpy", 	tag: Tag::from_bytes(b"BPY ") }, // Bishnupriya -> Bishnupriya Manipuri
    LangTag {
        language: "bqi",
        tag: Tag::from_bytes(b"LRC "),
    }, // Bakhtiari -> Luri
    LangTag {
        language: "br",
        tag: Tag::from_bytes(b"BRE "),
    }, // Breton
    LangTag {
        language: "bra",
        tag: Tag::from_bytes(b"BRI "),
    }, // Braj -> Braj Bhasha
    //  LangTag { language: "brh", 	tag: Tag::from_bytes(b"BRH ") }, // Brahui
    //  LangTag { language: "brx", 	tag: Tag::from_bytes(b"BRX ") }, // Bodo (India)
    LangTag {
        language: "bs",
        tag: Tag::from_bytes(b"BOS "),
    }, // Bosnian
    //  LangTag { language: "bsk", 	tag: Tag::from_bytes(b"BSK ") }, // Burushaski
    LangTag {
        language: "btb",
        tag: Tag::from_bytes(b"BTI "),
    }, // Beti (Cameroon)(retired code)
    LangTag {
        language: "btj",
        tag: Tag::from_bytes(b"MLY "),
    }, // Bacanese Malay -> Malay
    LangTag {
        language: "bto",
        tag: Tag::from_bytes(b"BIK "),
    }, // Rinconada Bikol -> Bikol
    ...
    LangTag {
        language: "bxr",
        tag: Tag::from_bytes(b"RBU "),
    }, // Russia Buriat -> Russian Buriat
    LangTag {
        language: "byn",
        tag: Tag::from_bytes(b"BIL "),
    }, // Bilin -> Bilen
    //  LangTag { language: "byv", 	tag: Tag::from_bytes(b"BYV ") }, // Medumba
    LangTag {
        language: "bzc",
        tag: Tag::from_bytes(b"MLG "),
    }, // Southern Betsimisaraka Malagasy -> Malagasy
    LangTag {
        language: "ca",
        tag: Tag::from_bytes(b"CAT "),
    }, // Catalan
    LangTag {
        language: "caf",
        tag: Tag::from_bytes(b"CRR "),
    }, // Southern Carrier -> Carrier
    LangTag {
        language: "caf",
        tag: Tag::from_bytes(b"ATH "),
    }, // Southern Carrier -> Athapaskan
    ...
    LangTag {
        language: "cco",
        tag: Tag::from_bytes(b"CCHN"),
    }, // Comaltepec Chinantec -> Chinantec
    LangTag {
        language: "ccq",
        tag: Tag::from_bytes(b"ARK "),
    }, // Chaungtha(retired code) -> Rakhine
    LangTag {
        language: "cdo",
        tag: Tag::from_bytes(b"ZHS "),
    }, // Min Dong Chinese -> Chinese Simplified
    LangTag {
        language: "ce",
        tag: Tag::from_bytes(b"CHE "),
    }, // Chechen
    //  LangTag { language: "ceb", 	tag: Tag::from_bytes(b"CEB ") }, // Cebuano
    LangTag {
        language: "cfm",
        tag: Tag::from_bytes(b"HAL "),
    }, // Halam (Falam Chin)
    //  LangTag { language: "cgg", 	tag: Tag::from_bytes(b"CGG ") }, // Chiga
    LangTag {
        language: "ch",
        tag: Tag::from_bytes(b"CHA "),
    }, // Chamorro
    LangTag {
        language: "chj",
        tag: Tag::from_bytes(b"CCHN"),
    }, // Ojitlán Chinantec -> Chinantec
    LangTag {
        language: "chk",
        tag: Tag::from_bytes(b"CHK0"),
    }, // Chuukese
    //  LangTag { language: "cho", 	tag: Tag::from_bytes(b"CHO ") }, // Choctaw
    LangTag {
        language: "chp",
        tag: Tag::from_bytes(b"CHP "),
    }, // Chipewyan
    LangTag {
        language: "chp",
        tag: Tag::from_bytes(b"SAY "),
    }, // Chipewyan -> Sayisi
    LangTag {
        language: "chp",
        tag: Tag::from_bytes(b"ATH "),
    }, // Chipewyan -> Athapaskan
    LangTag {
        language: "chq",
        tag: Tag::from_bytes(b"CCHN"),
    }, // Quiotepec Chinantec -> Chinantec
    //  LangTag { language: "chr", 	tag: Tag::from_bytes(b"CHR ") }, // Cherokee
    //  LangTag { language: "chy", 	tag: Tag::from_bytes(b"CHY ") }, // Cheyenne
    LangTag {
        language: "chz",
        tag: Tag::from_bytes(b"CCHN"),
    }, // Ozumacín Chinantec -> Chinantec
    LangTag {
        language: "ciw",
        tag: Tag::from_bytes(b"OJB "),
    }, // Chippewa -> Ojibway
    ...
    LangTag {
        language: "cjy",
        tag: Tag::from_bytes(b"ZHS "),
    }, // Jinyu Chinese -> Chinese Simplified
    LangTag {
        language: "cka",
        tag: Tag::from_bytes(b"QIN "),
    }, // Khumi Awa Chin(retired code) -> Chin
    LangTag {
        language: "ckb",
        tag: Tag::from_bytes(b"KUR "),
    }, // Central Kurdish -> Kurdish
    LangTag {
        language: "ckt",
        tag: Tag::from_bytes(b"CHK "),
    }, // Chukot -> Chukchi
    LangTag {
        language: "clc",
        tag: Tag::from_bytes(b"ATH "),
    ...
    LangTag {
        language: "cnl",
        tag: Tag::from_bytes(b"CCHN"),
    }, // Lalana Chinantec -> Chinantec
    LangTag {
        language: "cnt",
        tag: Tag::from_bytes(b"CCHN"),
    }, // Tepetotutla Chinantec -> Chinantec
    LangTag {
        language: "cnw",
        tag: Tag::from_bytes(b"QIN "),
    }, // Ngawn Chin -> Chin
    LangTag {
        language: "co",
        tag: Tag::from_bytes(b"COS "),
    }, // Corsican
    LangTag {
        language: "coa",
        tag: Tag::from_bytes(b"MLY "),
    }, // Cocos Islands Malay -> Malay
    ...
    LangTag {
        language: "cpa",
        tag: Tag::from_bytes(b"CCHN"),
    }, // Palantla Chinantec -> Chinantec
    LangTag {
        language: "cpe",
        tag: Tag::from_bytes(b"CPP "),
    }, // English-based creoles and pidgins [family] -> Creoles
    LangTag {
        language: "cpf",
        tag: Tag::from_bytes(b"CPP "),
    }, // French-based creoles and pidgins [family] -> Creoles
    //  LangTag { language: "cpp", 	tag: Tag::from_bytes(b"CPP ") }, // Portuguese-based creoles and pidgins [family] -> Creoles
    LangTag {
        language: "cpx",
        tag: Tag::from_bytes(b"ZHS "),
    }, // Pu-Xian Chinese -> Chinese Simplified
    LangTag {
        language: "cqd",
        tag: Tag::from_bytes(b"HMN "),
    }, // Chuanqiandian Cluster Miao -> Hmong
    LangTag {
        language: "cqu",
        tag: Tag::from_bytes(b"QUH "),
    }, // Chilean Quechua(retired code) -> Quechua (Bolivia)
    LangTag {
        language: "cr",
        tag: Tag::from_bytes(b"CRE "),
    }, // Cree [macrolanguage]
    LangTag {
        language: "cr",
        tag: Tag::from_bytes(b"YCR "),
    }, // Cree [macrolanguage] -> Y-Cree
    LangTag {
        language: "crh",
        tag: Tag::from_bytes(b"CRT "),
    }, // Crimean Tatar
    LangTag {
        language: "crj",
        tag: Tag::from_bytes(b"ECR "),
    }, // Southern East Cree -> Eastern Cree
    LangTag {
        language: "crk",
        tag: Tag::from_bytes(b"WCR "),
    }, // Plains Cree -> West-Cree
    LangTag {
        language: "crl",
        tag: Tag::from_bytes(b"ECR "),
    }, // Northern East Cree -> Eastern Cree
    LangTag {
        language: "crm",
        tag: Tag::from_bytes(b"MCR "),
    }, // Moose Cree
    LangTag {
        language: "crm",
        tag: Tag::from_bytes(b"LCR "),
    }, // Moose Cree -> L-Cree
    LangTag {
        language: "crp",
        tag: Tag::from_bytes(b"CPP "),
    }, // Creoles and pidgins [family] -> Creoles
    LangTag {
        language: "crx",
        tag: Tag::from_bytes(b"CRR "),
    }, // Carrier
    ...
    LangTag {
        language: "cs",
        tag: Tag::from_bytes(b"CSY "),
    }, // Czech
    LangTag {
        language: "csa",
        tag: Tag::from_bytes(b"CCHN"),
    }, // Chiltepec Chinantec -> Chinantec
    ...
    LangTag {
        language: "cso",
        tag: Tag::from_bytes(b"CCHN"),
    }, // Sochiapam Chinantec -> Chinantec
    LangTag {
        language: "csw",
        tag: Tag::from_bytes(b"NCR "),
    }, // Swampy Cree -> N-Cree
    LangTag {
        language: "csw",
        tag: Tag::from_bytes(b"NHC "),
    }, // Swampy Cree -> Norway House Cree
    LangTag {
        language: "csy",
        tag: Tag::from_bytes(b"QIN "),
    }, // Siyin Chin -> Chin
    ...
    LangTag {
        language: "cte",
        tag: Tag::from_bytes(b"CCHN"),
    }, // Tepinapa Chinantec -> Chinantec
    //  LangTag { language: "ctg", 	tag: Tag::from_bytes(b"CTG ") }, // Chittagonian
    LangTag {
        language: "ctl",
        tag: Tag::from_bytes(b"CCHN"),
    }, // Tlacoatzintepec Chinantec -> Chinantec
    LangTag {
        language: "cts",
        tag: Tag::from_bytes(b"BIK "),
    }, // Northern Catanduanes Bikol -> Bikol
    LangTag {
        language: "cu",
        tag: Tag::from_bytes(b"CSL "),
    }, // Church Slavonic
    LangTag {
        language: "cuc",
        tag: Tag::from_bytes(b"CCHN"),
    }, // Usila Chinantec -> Chinantec
    //  LangTag { language: "cuk", 	tag: Tag::from_bytes(b"CUK ") }, // San Blas Kuna
    LangTag {
        language: "cv",
        tag: Tag::from_bytes(b"CHU "),
    }, // Chuvash
    LangTag {
        language: "cvn",
        tag: Tag::from_bytes(b"CCHN"),
    }, // Valle Nacional Chinantec -> Chinantec
    LangTag {
        language: "cwd",
        tag: Tag::from_bytes(b"DCR "),
    }, // Woods Cree
    LangTag {
        language: "cwd",
        tag: Tag::from_bytes(b"TCR "),
    }, // Woods Cree -> TH-Cree
    LangTag {
        language: "cy",
        tag: Tag::from_bytes(b"WEL "),
    }, // Welsh
    LangTag {
        language: "czh",
        tag: Tag::from_bytes(b"ZHS "),
    }, // Huizhou Chinese -> Chinese Simplified
    LangTag {
        language: "czo",
        tag: Tag::from_bytes(b"ZHS "),
    }, // Min Zhong Chinese -> Chinese Simplified
    LangTag {
        language: "czt",
        tag: Tag::from_bytes(b"QIN "),
    }, // Zotung Chin -> Chin
    ...
    LangTag {
        language: "dap",
        tag: Tag::from_bytes(b"NIS "),
    }, // Nisi (India)(retired code)
    //  LangTag { language: "dar", 	tag: Tag::from_bytes(b"DAR ") }, // Dargwa
    //  LangTag { language: "dax", 	tag: Tag::from_bytes(b"DAX ") }, // Dayi
    LangTag {
        language: "de",
        tag: Tag::from_bytes(b"DEU "),
    }, // German
    LangTag {
        language: "den",
        tag: Tag::from_bytes(b"SLA "),
    }, // Slave (Athapascan) [macrolanguage] -> Slavey
    LangTag {
        language: "den",
        tag: Tag::from_bytes(b"ATH "),
    }, // Slave (Athapascan) [macrolanguage] -> Athapaskan
    ...
    LangTag {
        language: "dhd",
        tag: Tag::from_bytes(b"MAW "),
    }, // Dhundari -> Marwari
    //  LangTag { language: "dhg", 	tag: Tag::from_bytes(b"DHG ") }, // Dhangu
    LangTag {
        language: "dib",
        tag: Tag::from_bytes(b"DNK "),
    }, // South Central Dinka -> Dinka
    LangTag {
        language: "dik",
        tag: Tag::from_bytes(b"DNK "),
    }, // Southwestern Dinka -> Dinka
    LangTag {
        language: "din",
        tag: Tag::from_bytes(b"DNK "),
    }, // Dinka [macrolanguage]
    LangTag {
        language: "dip",
        tag: Tag::from_bytes(b"DNK "),
    }, // Northeastern Dinka -> Dinka
    //  LangTag { language: "diq", 	tag: Tag::from_bytes(b"DIQ ") }, // Dimli
    LangTag {
        language: "diw",
        tag: Tag::from_bytes(b"DNK "),
    }, // Northwestern Dinka -> Dinka
    LangTag {
        language: "dje",
        tag: Tag::from_bytes(b"DJR "),
    }, // Zarma
    LangTag {
        language: "djr",
        tag: Tag::from_bytes(b"DJR0"),
    }, // Djambarrpuyngu
    LangTag {
        language: "dks",
        tag: Tag::from_bytes(b"DNK "),
    }, // Southeastern Dinka -> Dinka
    LangTag {
        language: "dng",
        tag: Tag::from_bytes(b"DUN "),
    }, // Dungan
    //  LangTag { language: "dnj", 	tag: Tag::from_bytes(b"DNJ ") }, // Dan
    LangTag {
        language: "doi",
        tag: Tag::from_bytes(b"DGR "),
    }, // Dogri  [macrolanguage]
    LangTag {
        language: "drh",
        tag: Tag::from_bytes(b"MNG "),
    }, // Darkhat(retired code) -> Mongolian
    LangTag {
        language: "drw",
        tag: Tag::from_bytes(b"DRI "),
    }, // Darwazi(retired code) -> Dari
    LangTag {
        language: "dsb",
        tag: Tag::from_bytes(b"LSB "),
    }, // Lower Sorbian
    LangTag {
        language: "dty",
        tag: Tag::from_bytes(b"NEP "),
    }, // Dotyali -> Nepali
    ...
    LangTag {
        language: "dv",
        tag: Tag::from_bytes(b"DIV "),
    }, // Divehi (Dhivehi, Maldivian)
    LangTag {
        language: "dv",
        tag: Tag::from_bytes(b"DHV "),
    }, // Divehi (Dhivehi, Maldivian)(deprecated)
    LangTag {
        language: "dwu",
        tag: Tag::from_bytes(b"DUJ "),
    }, // Dhuwal
    LangTag {
        language: "dwy",
        tag: Tag::from_bytes(b"DUJ "),
    ...
    LangTag {
        language: "ee",
        tag: Tag::from_bytes(b"EWE "),
    }, // Ewe
    //  LangTag { language: "efi", 	tag: Tag::from_bytes(b"EFI ") }, // Efik
    LangTag {
        language: "ekk",
        tag: Tag::from_bytes(b"ETI "),
    }, // Standard Estonian -> Estonian
    LangTag {
        language: "el",
        tag: Tag::from_bytes(b"ELL "),
    }, // Modern Greek (1453-) -> Greek
    LangTag {
        language: "emk",
        tag: Tag::from_bytes(b"EMK "),
    }, // Eastern Maninkakan
    LangTag {
        language: "emk",
        tag: Tag::from_bytes(b"MNK "),
    }, // Eastern Maninkakan -> Maninka
    LangTag {
        language: "en",
        tag: Tag::from_bytes(b"ENG "),
    }, // English
    LangTag {
        language: "enb",
        tag: Tag::from_bytes(b"KAL "),
    }, // Markweeta -> Kalenjin
    LangTag {
        language: "enf",
        tag: Tag::from_bytes(b"FNE "),
    }, // Forest Enets -> Forest Nenets
    LangTag {
        language: "enh",
        tag: Tag::from_bytes(b"TNE "),
    }, // Tundra Enets -> Tundra Nenets
    LangTag {
        language: "eo",
        tag: Tag::from_bytes(b"NTO "),
    }, // Esperanto
    LangTag {
        language: "es",
        tag: Tag::from_bytes(b"ESP "),
    }, // Spanish
    LangTag {
        language: "esg",
        tag: Tag::from_bytes(b"GON "),
    }, // Aheri Gondi -> Gondi
    LangTag {
        language: "esi",
        tag: Tag::from_bytes(b"IPK "),
    }, // North Alaskan Inupiatun -> Inupiat
    LangTag {
        language: "esk",
        tag: Tag::from_bytes(b"IPK "),
    }, // Northwest Alaska Inupiatun -> Inupiat
    //  LangTag { language: "esu", 	tag: Tag::from_bytes(b"ESU ") }, // Central Yupik
    LangTag {
        language: "et",
        tag: Tag::from_bytes(b"ETI "),
    }, // Estonian [macrolanguage]
    LangTag {
        language: "eto",
        tag: Tag::from_bytes(b"BTI "),
    }, // Eton (Cameroon) -> Beti
    LangTag {
        language: "eu",
        tag: Tag::from_bytes(b"EUQ "),
    }, // Basque
    LangTag {
        language: "eve",
        tag: Tag::from_bytes(b"EVN "),
    }, // Even
    LangTag {
        language: "evn",
        tag: Tag::from_bytes(b"EVK "),
    }, // Evenki
    LangTag {
        language: "ewo",
        tag: Tag::from_bytes(b"BTI "),
    ...
    LangTag {
        language: "fa",
        tag: Tag::from_bytes(b"FAR "),
    }, // Persian [macrolanguage]
    LangTag {
        language: "fan",
        tag: Tag::from_bytes(b"FAN0"),
    }, // Fang (Equatorial Guinea)
    //  LangTag { language: "fat", 	tag: Tag::from_bytes(b"FAT ") }, // Fanti
    LangTag {
        language: "fbl",
        tag: Tag::from_bytes(b"BIK "),
    }, // West Albay Bikol -> Bikol
    LangTag {
        language: "ff",
        tag: Tag::from_bytes(b"FUL "),
    }, // Fulah [macrolanguage]
    LangTag {
        language: "ffm",
        tag: Tag::from_bytes(b"FUL "),
    }, // Maasina Fulfulde -> Fulah
    LangTag {
        language: "fi",
        tag: Tag::from_bytes(b"FIN "),
    }, // Finnish
    LangTag {
        language: "fil",
        tag: Tag::from_bytes(b"PIL "),
    }, // Filipino
    LangTag {
        language: "fj",
        tag: Tag::from_bytes(b"FJI "),
    }, // Fijian
    LangTag {
        language: "flm",
        tag: Tag::from_bytes(b"HAL "),
    }, // Halam (Falam Chin)(retired code)
    LangTag {
        language: "flm",
        tag: Tag::from_bytes(b"QIN "),
    }, // Falam Chin(retired code) -> Chin
    //  LangTag { language: "fmp", 	tag: Tag::from_bytes(b"FMP ") }, // Fe’fe’
    LangTag {
        language: "fo",
        tag: Tag::from_bytes(b"FOS "),
    }, // Faroese
    //  LangTag { language: "fon", 	tag: Tag::from_bytes(b"FON ") }, // Fon
    LangTag {
        language: "fr",
        tag: Tag::from_bytes(b"FRA "),
    }, // French
    ...
    LangTag {
        language: "fue",
        tag: Tag::from_bytes(b"FUL "),
    }, // Borgu Fulfulde -> Fulah
    LangTag {
        language: "fuf",
        tag: Tag::from_bytes(b"FTA "),
    }, // Pular -> Futa
    LangTag {
        language: "fuh",
        tag: Tag::from_bytes(b"FUL "),
    }, // Western Niger Fulfulde -> Fulah
    LangTag {
        language: "fui",
        tag: Tag::from_bytes(b"FUL "),
    }, // Bagirmi Fulfulde -> Fulah
    LangTag {
        language: "fuq",
        tag: Tag::from_bytes(b"FUL "),
    }, // Central-Eastern Niger Fulfulde -> Fulah
    LangTag {
        language: "fur",
        tag: Tag::from_bytes(b"FRL "),
    }, // Friulian
    //  LangTag { language: "fuv", 	tag: Tag::from_bytes(b"FUV ") }, // Nigerian Fulfulde
    LangTag {
        language: "fy",
        tag: Tag::from_bytes(b"FRI "),
    }, // Western Frisian -> Frisian
    LangTag {
        language: "ga",
        tag: Tag::from_bytes(b"IRI "),
    }, // Irish
    LangTag {
        language: "gaa",
        tag: Tag::from_bytes(b"GAD "),
    }, // Ga
    //  LangTag { language: "gag", 	tag: Tag::from_bytes(b"GAG ") }, // Gagauz
    LangTag {
        language: "gan",
        tag: Tag::from_bytes(b"ZHS "),
    }, // Gan Chinese -> Chinese Simplified
    LangTag {
        language: "gax",
        tag: Tag::from_bytes(b"ORO "),
    ...
    LangTag {
        language: "gd",
        tag: Tag::from_bytes(b"GAE "),
    }, // Scottish Gaelic (Gaelic)
    LangTag {
        language: "gda",
        tag: Tag::from_bytes(b"RAJ "),
    }, // Gade Lohar -> Rajasthani
    //  LangTag { language: "gez", 	tag: Tag::from_bytes(b"GEZ ") }, // Geez
    LangTag {
        language: "ggo",
        tag: Tag::from_bytes(b"GON "),
    }, // Southern Gondi(retired code) -> Gondi
    //  LangTag { language: "gih", 	tag: Tag::from_bytes(b"GIH ") }, // Githabul
    LangTag {
        language: "gil",
        tag: Tag::from_bytes(b"GIL0"),
    }, // Kiribati (Gilbertese)
    LangTag {
        language: "gju",
        tag: Tag::from_bytes(b"RAJ "),
    ...
    LangTag {
        language: "gui",
        tag: Tag::from_bytes(b"GUA "),
    }, // Eastern Bolivian Guaraní -> Guarani
    LangTag {
        language: "guk",
        tag: Tag::from_bytes(b"GMZ "),
    }, // Gumuz
    LangTag {
        language: "guk",
        tag: Tag::from_bytes(b"GUK "),
    }, // Gumuz(SIL fonts)
    LangTag {
        language: "gun",
        tag: Tag::from_bytes(b"GUA "),
    }, // Mbyá Guaraní -> Guarani
    //  LangTag { language: "guz", 	tag: Tag::from_bytes(b"GUZ ") }, // Gusii
    LangTag {
        language: "gv",
        tag: Tag::from_bytes(b"MNX "),
    }, // Manx
    LangTag {
        language: "gwi",
        tag: Tag::from_bytes(b"ATH "),
    ...
    LangTag {
        language: "hak",
        tag: Tag::from_bytes(b"ZHS "),
    }, // Hakka Chinese -> Chinese Simplified
    LangTag {
        language: "har",
        tag: Tag::from_bytes(b"HRI "),
    }, // Harari
    ...
    LangTag {
        language: "he",
        tag: Tag::from_bytes(b"IWR "),
    }, // Hebrew
    LangTag {
        language: "hea",
        tag: Tag::from_bytes(b"HMN "),
    }, // Northern Qiandong Miao -> Hmong
    LangTag {
        language: "hi",
        tag: Tag::from_bytes(b"HIN "),
    }, // Hindi
    ...
    LangTag {
        language: "hma",
        tag: Tag::from_bytes(b"HMN "),
    }, // Southern Mashan Hmong -> Hmong
    LangTag {
        language: "hmc",
        tag: Tag::from_bytes(b"HMN "),
    }, // Central Huishui Hmong -> Hmong
    LangTag {
        language: "hmd",
        tag: Tag::from_bytes(b"HMN "),
    }, // Large Flowery Miao -> Hmong
    LangTag {
        language: "hme",
        tag: Tag::from_bytes(b"HMN "),
    }, // Eastern Huishui Hmong -> Hmong
    LangTag {
        language: "hmg",
        tag: Tag::from_bytes(b"HMN "),
    }, // Southwestern Guiyang Hmong -> Hmong
    LangTag {
        language: "hmh",
        tag: Tag::from_bytes(b"HMN "),
    }, // Southwestern Huishui Hmong -> Hmong
    LangTag {
        language: "hmi",
        tag: Tag::from_bytes(b"HMN "),
    }, // Northern Huishui Hmong -> Hmong
    LangTag {
        language: "hmj",
        tag: Tag::from_bytes(b"HMN "),
    }, // Ge -> Hmong
    ...
    LangTag {
        language: "hmm",
        tag: Tag::from_bytes(b"HMN "),
    }, // Central Mashan Hmong -> Hmong
    //  LangTag { language: "hmn", 	tag: Tag::from_bytes(b"HMN ") }, // Hmong [macrolanguage]
    LangTag {
        language: "hmp",
        tag: Tag::from_bytes(b"HMN "),
    }, // Northern Mashan Hmong -> Hmong
    LangTag {
        language: "hmq",
        tag: Tag::from_bytes(b"HMN "),
    }, // Eastern Qiandong Miao -> Hmong
    LangTag {
        language: "hms",
        tag: Tag::from_bytes(b"HMN "),
    }, // Southern Qiandong Miao -> Hmong
    LangTag {
        language: "hmw",
        tag: Tag::from_bytes(b"HMN "),
    }, // Western Mashan Hmong -> Hmong
    LangTag {
        language: "hmy",
        tag: Tag::from_bytes(b"HMN "),
    }, // Southern Guiyang Hmong -> Hmong
    LangTag {
        language: "hmz",
        tag: Tag::from_bytes(b"HMN "),
    }, // Hmong Shua -> Hmong
    ...
    LangTag {
        language: "hno",
        tag: Tag::from_bytes(b"HND "),
    }, // Northern Hindko -> Hindko
    LangTag {
        language: "ho",
        tag: Tag::from_bytes(b"HMO "),
    }, // Hiri Motu
    LangTag {
        language: "hoc",
        tag: Tag::from_bytes(b"HO  "),
    }, // Ho
    LangTag {
        language: "hoi",
        tag: Tag::from_bytes(b"ATH "),
    }, // Holikachuk -> Athapaskan
    LangTag {
        language: "hoj",
        tag: Tag::from_bytes(b"HAR "),
    }, // Hadothi -> Harauti
    LangTag {
        language: "hr",
        tag: Tag::from_bytes(b"HRV "),
    }, // Croatian
    LangTag {
        language: "hrm",
        tag: Tag::from_bytes(b"HMN "),
    ...
    LangTag {
        language: "hsb",
        tag: Tag::from_bytes(b"USB "),
    }, // Upper Sorbian
    LangTag {
        language: "hsn",
        tag: Tag::from_bytes(b"ZHS "),
    }, // Xiang Chinese -> Chinese Simplified
    LangTag {
        language: "ht",
        tag: Tag::from_bytes(b"HAI "),
    }, // Haitian (Haitian Creole)
    LangTag {
        language: "hu",
        tag: Tag::from_bytes(b"HUN "),
    }, // Hungarian
    LangTag {
        language: "huj",
        tag: Tag::from_bytes(b"HMN "),
    }, // Northern Guiyang Hmong -> Hmong
    LangTag {
        language: "hup",
        tag: Tag::from_bytes(b"ATH "),
    }, // Hupa -> Athapaskan
    LangTag {
        language: "hy",
        tag: Tag::from_bytes(b"HYE0"),
    }, // Armenian -> Armenian East
    LangTag {
        language: "hy",
        tag: Tag::from_bytes(b"HYE "),
    }, // Armenian
    LangTag {
        language: "hyw",
        tag: Tag::from_bytes(b"HYE "),
    ...
    LangTag {
        language: "hz",
        tag: Tag::from_bytes(b"HER "),
    }, // Herero
    LangTag {
        language: "ia",
        tag: Tag::from_bytes(b"INA "),
    }, // Interlingua (International Auxiliary Language Association)
    //  LangTag { language: "iba", 	tag: Tag::from_bytes(b"IBA ") }, // Iban
    //  LangTag { language: "ibb", 	tag: Tag::from_bytes(b"IBB ") }, // Ibibio
    LangTag {
        language: "id",
        tag: Tag::from_bytes(b"IND "),
    }, // Indonesian
    LangTag {
        language: "ida",
        tag: Tag::from_bytes(b"LUH "),
    }, // Idakho-Isukha-Tiriki -> Luyia
    LangTag {
        language: "ie",
        tag: Tag::from_bytes(b"ILE "),
    }, // Interlingue
    LangTag {
        language: "ig",
        tag: Tag::from_bytes(b"IBO "),
    }, // Igbo
    LangTag {
        language: "igb",
        tag: Tag::from_bytes(b"EBI "),
    }, // Ebira
    LangTag {
        language: "ii",
        tag: Tag::from_bytes(b"YIM "),
    }, // Sichuan Yi -> Yi Modern
    LangTag {
        language: "ijc",
        tag: Tag::from_bytes(b"IJO "),
    }, // Izon -> Ijo
    //  LangTag { language: "ijo", 	tag: Tag::from_bytes(b"IJO ") }, // Ijo  [family]
    LangTag {
        language: "ik",
        tag: Tag::from_bytes(b"IPK "),
    }, // Inupiaq [macrolanguage] -> Inupiat
    LangTag {
        language: "ike",
        tag: Tag::from_bytes(b"INU "),
    }, // Eastern Canadian Inuktitut -> Inuktitut
    LangTag {
        language: "ikt",
        tag: Tag::from_bytes(b"INU "),
    ...
    LangTag {
        language: "in",
        tag: Tag::from_bytes(b"IND "),
    }, // Indonesian(retired code)
    LangTag {
        language: "ing",
        tag: Tag::from_bytes(b"ATH "),
    }, // Degexit'an -> Athapaskan
    LangTag {
        language: "inh",
        tag: Tag::from_bytes(b"ING "),
    }, // Ingush
    LangTag {
        language: "io",
        tag: Tag::from_bytes(b"IDO "),
    }, // Ido
    LangTag {
        language: "is",
        tag: Tag::from_bytes(b"ISL "),
    }, // Icelandic
    LangTag {
        language: "it",
        tag: Tag::from_bytes(b"ITA "),
    }, // Italian
    LangTag {
        language: "iu",
        tag: Tag::from_bytes(b"INU "),
    }, // Inuktitut [macrolanguage]
    LangTag {
        language: "iw",
        tag: Tag::from_bytes(b"IWR "),
    }, // Hebrew(retired code)
    ...
    LangTag {
        language: "ji",
        tag: Tag::from_bytes(b"JII "),
    }, // Yiddish(retired code)
    LangTag {
        language: "jv",
        tag: Tag::from_bytes(b"JAV "),
    }, // Javanese
    LangTag {
        language: "jw",
        tag: Tag::from_bytes(b"JAV "),
    }, // Javanese(retired code)
    LangTag {
        language: "ka",
        tag: Tag::from_bytes(b"KAT "),
    }, // Georgian
    LangTag {
        language: "kaa",
        tag: Tag::from_bytes(b"KRK "),
    }, // Kara-Kalpak -> Karakalpak
    LangTag {
        language: "kab",
        tag: Tag::from_bytes(b"KAB0"),
    }, // Kabyle
    LangTag {
        language: "kam",
        tag: Tag::from_bytes(b"KMB "),
    }, // Kamba (Kenya)
    LangTag {
        language: "kar",
        tag: Tag::from_bytes(b"KRN "),
    }, // Karen  [family]
    LangTag {
        language: "kbd",
        tag: Tag::from_bytes(b"KAB "),
    }, // Kabardian
    LangTag {
        language: "kby",
        tag: Tag::from_bytes(b"KNR "),
    }, // Manga Kanuri -> Kanuri
    LangTag {
        language: "kca",
        tag: Tag::from_bytes(b"KHK "),
    }, // Khanty -> Khanty-Kazim
    LangTag {
        language: "kca",
        tag: Tag::from_bytes(b"KHS "),
    }, // Khanty -> Khanty-Shurishkar
    LangTag {
        language: "kca",
        tag: Tag::from_bytes(b"KHV "),
    }, // Khanty -> Khanty-Vakhi
    //  LangTag { language: "kde", 	tag: Tag::from_bytes(b"KDE ") }, // Makonde
    LangTag {
        language: "kdr",
        tag: Tag::from_bytes(b"KRM "),
    }, // Karaim
    LangTag {
        language: "kdt",
        tag: Tag::from_bytes(b"KUY "),
    }, // Kuy
    //  LangTag { language: "kea", 	tag: Tag::from_bytes(b"KEA ") }, // Kabuverdianu (Crioulo)
    //  LangTag { language: "kek", 	tag: Tag::from_bytes(b"KEK ") }, // Kekchi
    LangTag {
        language: "kex",
        tag: Tag::from_bytes(b"KKN "),
    }, // Kukna -> Kokni
    LangTag {
        language: "kfa",
        tag: Tag::from_bytes(b"KOD "),
    }, // Kodava -> Kodagu
    LangTag {
        language: "kfr",
        tag: Tag::from_bytes(b"KAC "),
    }, // Kachhi -> Kachchi
    LangTag {
        language: "kfx",
        tag: Tag::from_bytes(b"KUL "),
    }, // Kullu Pahari -> Kulvi
    LangTag {
        language: "kfy",
        tag: Tag::from_bytes(b"KMN "),
    }, // Kumaoni
    LangTag {
        language: "kg",
        tag: Tag::from_bytes(b"KON0"),
    }, // Kongo [macrolanguage]
    LangTag {
        language: "kha",
        tag: Tag::from_bytes(b"KSI "),
    }, // Khasi
    LangTag {
        language: "khb",
        tag: Tag::from_bytes(b"XBD "),
    }, // Lü
    LangTag {
        language: "khk",
        tag: Tag::from_bytes(b"MNG "),
    ...
    LangTag {
        language: "kht",
        tag: Tag::from_bytes(b"KHN "),
    }, // Khamti -> Khamti Shan(Microsoft fonts)
    LangTag {
        language: "kht",
        tag: Tag::from_bytes(b"KHT "),
    }, // Khamti -> Khamti Shan(OpenType spec and SIL fonts)
    //  LangTag { language: "khw", 	tag: Tag::from_bytes(b"KHW ") }, // Khowar
    LangTag {
        language: "ki",
        tag: Tag::from_bytes(b"KIK "),
    }, // Kikuyu (Gikuyu)
    //  LangTag { language: "kiu", 	tag: Tag::from_bytes(b"KIU ") }, // Kirmanjki
    LangTag {
        language: "kj",
        tag: Tag::from_bytes(b"KUA "),
    }, // Kuanyama
    //  LangTag { language: "kjd", 	tag: Tag::from_bytes(b"KJD ") }, // Southern Kiwai
    LangTag {
        language: "kjh",
        tag: Tag::from_bytes(b"KHA "),
    }, // Khakas -> Khakass
    ...
    LangTag {
        language: "km",
        tag: Tag::from_bytes(b"KHM "),
    }, // Khmer
    LangTag {
        language: "kmb",
        tag: Tag::from_bytes(b"MBN "),
    }, // Kimbundu -> Mbundu
    LangTag {
        language: "kmr",
        tag: Tag::from_bytes(b"KUR "),
    ...
    LangTag {
        language: "ko",
        tag: Tag::from_bytes(b"KOR "),
    }, // Korean
    LangTag {
        language: "koi",
        tag: Tag::from_bytes(b"KOP "),
    }, // Komi-Permyak
    ...
    LangTag {
        language: "kpe",
        tag: Tag::from_bytes(b"KPL "),
    }, // Kpelle [macrolanguage]
    LangTag {
        language: "kpv",
        tag: Tag::from_bytes(b"KOZ "),
    }, // Komi-Zyrian
    LangTag {
        language: "kpy",
        tag: Tag::from_bytes(b"KYK "),
    }, // Koryak
    LangTag {
        language: "kqs",
        tag: Tag::from_bytes(b"KIS "),
    }, // Northern Kissi -> Kisii
    LangTag {
        language: "kqy",
        tag: Tag::from_bytes(b"KRT "),
    }, // Koorete
    LangTag {
        language: "kr",
        tag: Tag::from_bytes(b"KNR "),
    ...
    LangTag {
        language: "krc",
        tag: Tag::from_bytes(b"KAR "),
    }, // Karachay-Balkar -> Karachay
    LangTag {
        language: "krc",
        tag: Tag::from_bytes(b"BAL "),
    }, // Karachay-Balkar -> Balkar
    //  LangTag { language: "kri", 	tag: Tag::from_bytes(b"KRI ") }, // Krio
    //  LangTag { language: "krl", 	tag: Tag::from_bytes(b"KRL ") }, // Karelian
    LangTag {
        language: "krt",
        tag: Tag::from_bytes(b"KNR "),
    }, // Tumari Kanuri -> Kanuri
    LangTag {
        language: "kru",
        tag: Tag::from_bytes(b"KUU "),
    }, // Kurukh
    LangTag {
        language: "ks",
        tag: Tag::from_bytes(b"KSH "),
    }, // Kashmiri
    LangTag {
        language: "ksh",
        tag: Tag::from_bytes(b"KSH0"),
    }, // Kölsch -> Ripuarian
    LangTag {
        language: "kss",
        tag: Tag::from_bytes(b"KIS "),
    ...
    LangTag {
        language: "ktb",
        tag: Tag::from_bytes(b"KEB "),
    }, // Kambaata -> Kebena
    LangTag {
        language: "ktu",
        tag: Tag::from_bytes(b"KON "),
    }, // Kituba (Democratic Republic of Congo) -> Kikongo
    LangTag {
        language: "ktw",
        tag: Tag::from_bytes(b"ATH "),
    }, // Kato -> Athapaskan
    ...
    LangTag {
        language: "kuu",
        tag: Tag::from_bytes(b"ATH "),
    }, // Upper Kuskokwim -> Athapaskan
    LangTag {
        language: "kv",
        tag: Tag::from_bytes(b"KOM "),
    }, // Komi [macrolanguage]
    LangTag {
        language: "kvb",
        tag: Tag::from_bytes(b"MLY "),
    ...
    LangTag {
        language: "kw",
        tag: Tag::from_bytes(b"COR "),
    }, // Cornish
    LangTag {
        language: "kwy",
        tag: Tag::from_bytes(b"KON0"),
    }, // San Salvador Kongo -> Kongo
    LangTag {
        language: "kxc",
        tag: Tag::from_bytes(b"KMS "),
    }, // Konso -> Komso
    LangTag {
        language: "kxd",
        tag: Tag::from_bytes(b"MLY "),
    ...
    LangTag {
        language: "kxu",
        tag: Tag::from_bytes(b"KUI "),
    }, // Kui (India)
    LangTag {
        language: "ky",
        tag: Tag::from_bytes(b"KIR "),
    }, // Kirghiz (Kyrgyz)
    //  LangTag { language: "kyu", 	tag: Tag::from_bytes(b"KYU ") }, // Western Kayah
    LangTag {
        language: "la",
        tag: Tag::from_bytes(b"LAT "),
    }, // Latin
    LangTag {
        language: "lad",
        tag: Tag::from_bytes(b"JUD "),
    }, // Ladino
    LangTag {
        language: "lb",
        tag: Tag::from_bytes(b"LTZ "),
    }, // Luxembourgish
    LangTag {
        language: "lbe",
        tag: Tag::from_bytes(b"LAK "),
    }, // Lak
    LangTag {
        language: "lbj",
        tag: Tag::from_bytes(b"LDK "),
    }, // Ladakhi
    LangTag {
        language: "lbl",
        tag: Tag::from_bytes(b"BIK "),
    ...
    LangTag {
        language: "lg",
        tag: Tag::from_bytes(b"LUG "),
    }, // Ganda
    LangTag {
        language: "li",
        tag: Tag::from_bytes(b"LIM "),
    }, // Limburgish
    LangTag {
        language: "lif",
        tag: Tag::from_bytes(b"LMB "),
    }, // Limbu
    ...
    LangTag {
        language: "lld",
        tag: Tag::from_bytes(b"LAD "),
    }, // Ladin
    LangTag {
        language: "lmn",
        tag: Tag::from_bytes(b"LAM "),
    }, // Lambadi -> Lambani
    //  LangTag { language: "lmo", 	tag: Tag::from_bytes(b"LMO ") }, // Lombard
    LangTag {
        language: "ln",
        tag: Tag::from_bytes(b"LIN "),
    }, // Lingala
    LangTag {
        language: "lo",
        tag: Tag::from_bytes(b"LAO "),
    }, // Lao
    ...
    LangTag {
        language: "lt",
        tag: Tag::from_bytes(b"LTH "),
    }, // Lithuanian
    LangTag {
        language: "ltg",
        tag: Tag::from_bytes(b"LVI "),
    }, // Latgalian -> Latvian
    LangTag {
        language: "lto",
        tag: Tag::from_bytes(b"LUH "),
    ...
    LangTag {
        language: "lzh",
        tag: Tag::from_bytes(b"ZHT "),
    }, // Literary Chinese -> Chinese Traditional
    LangTag {
        language: "lzz",
        tag: Tag::from_bytes(b"LAZ "),
    }, // Laz
    //  LangTag { language: "mad", 	tag: Tag::from_bytes(b"MAD ") }, // Madurese -> Madura
    //  LangTag { language: "mag", 	tag: Tag::from_bytes(b"MAG ") }, // Magahi
    LangTag {
        language: "mai",
        tag: Tag::from_bytes(b"MTH "),
    }, // Maithili
    LangTag {
        language: "mak",
        tag: Tag::from_bytes(b"MKR "),
    }, // Makasar
    //  LangTag { language: "mam", 	tag: Tag::from_bytes(b"MAM ") }, // Mam
    LangTag {
        language: "man",
        tag: Tag::from_bytes(b"MNK "),
    }, // Mandingo [macrolanguage] -> Maninka
    LangTag {
        language: "max",
        tag: Tag::from_bytes(b"MLY "),
    }, // North Moluccan Malay -> Malay
    ...
    LangTag {
        language: "mdf",
        tag: Tag::from_bytes(b"MOK "),
    }, // Moksha
    //  LangTag { language: "mdr", 	tag: Tag::from_bytes(b"MDR ") }, // Mandar
    LangTag {
        language: "mdy",
        tag: Tag::from_bytes(b"MLE "),
    }, // Male (Ethiopia)
    LangTag {
        language: "men",
        tag: Tag::from_bytes(b"MDE "),
    }, // Mende (Sierra Leone)
    LangTag {
        language: "meo",
        tag: Tag::from_bytes(b"MLY "),
    ...
    LangTag {
        language: "mh",
        tag: Tag::from_bytes(b"MAH "),
    }, // Marshallese
    LangTag {
        language: "mhr",
        tag: Tag::from_bytes(b"LMA "),
    }, // Eastern Mari -> Low Mari
    LangTag {
        language: "mhv",
        tag: Tag::from_bytes(b"ARK "),
    }, // Arakanese(retired code) -> Rakhine
    LangTag {
        language: "mi",
        tag: Tag::from_bytes(b"MRI "),
    }, // Maori
    //  LangTag { language: "min", 	tag: Tag::from_bytes(b"MIN ") }, // Minangkabau
    LangTag {
        language: "mk",
        tag: Tag::from_bytes(b"MKD "),
    }, // Macedonian
    LangTag {
        language: "mku",
        tag: Tag::from_bytes(b"MNK "),
    }, // Konyanka Maninka -> Maninka
    //  LangTag { language: "mkw", 	tag: Tag::from_bytes(b"MKW ") }, // Kituba (Congo)
    LangTag {
        language: "ml",
        tag: Tag::from_bytes(b"MAL "),
    }, // Malayalam -> Malayalam Traditional
    LangTag {
        language: "ml",
        tag: Tag::from_bytes(b"MLR "),
    }, // Malayalam -> Malayalam Reformed
    LangTag {
        language: "mlq",
        tag: Tag::from_bytes(b"MLN "),
    }, // Western Maninkakan -> Malinke
    LangTag {
        language: "mlq",
        tag: Tag::from_bytes(b"MNK "),
    }, // Western Maninkakan -> Maninka
    LangTag {
        language: "mmr",
        tag: Tag::from_bytes(b"HMN "),
    }, // Western Xiangxi Miao -> Hmong
    LangTag {
        language: "mn",
        tag: Tag::from_bytes(b"MNG "),
    ...
    LangTag {
        language: "mnp",
        tag: Tag::from_bytes(b"ZHS "),
    }, // Min Bei Chinese -> Chinese Simplified
    LangTag {
        language: "mns",
        tag: Tag::from_bytes(b"MAN "),
    }, // Mansi
    LangTag {
        language: "mnw",
        tag: Tag::from_bytes(b"MON "),
    }, // Mon
    LangTag {
        language: "mo",
        tag: Tag::from_bytes(b"MOL "),
    }, // Moldavian(retired code)
    //  LangTag { language: "moh", 	tag: Tag::from_bytes(b"MOH ") }, // Mohawk
    //  LangTag { language: "mos", 	tag: Tag::from_bytes(b"MOS ") }, // Mossi
    LangTag {
        language: "mpe",
        tag: Tag::from_bytes(b"MAJ "),
    }, // Majang
    LangTag {
        language: "mqg",
        tag: Tag::from_bytes(b"MLY "),
    }, // Kota Bangun Kutai Malay -> Malay
    LangTag {
        language: "mr",
        tag: Tag::from_bytes(b"MAR "),
    }, // Marathi
    LangTag {
        language: "mrh",
        tag: Tag::from_bytes(b"QIN "),
    ...
    LangTag {
        language: "mrj",
        tag: Tag::from_bytes(b"HMA "),
    }, // Western Mari -> High Mari
    LangTag {
        language: "ms",
        tag: Tag::from_bytes(b"MLY "),
    }, // Malay  [macrolanguage]
    LangTag {
        language: "msc",
        tag: Tag::from_bytes(b"MNK "),
    }, // Sankaran Maninka -> Maninka
    LangTag {
        language: "msh",
        tag: Tag::from_bytes(b"MLG "),
    }, // Masikoro Malagasy -> Malagasy
    LangTag {
        language: "msi",
        tag: Tag::from_bytes(b"MLY "),
    }, // Sabah Malay -> Malay
    ...
    LangTag {
        language: "mvf",
        tag: Tag::from_bytes(b"MNG "),
    }, // Peripheral Mongolian -> Mongolian
    LangTag {
        language: "mwk",
        tag: Tag::from_bytes(b"MNK "),
    }, // Kita Maninkakan -> Maninka
    ...
    LangTag {
        language: "my",
        tag: Tag::from_bytes(b"BRM "),
    }, // Burmese
    LangTag {
        language: "mym",
        tag: Tag::from_bytes(b"MEN "),
    }, // Me’en
    //  LangTag { language: "myn", 	tag: Tag::from_bytes(b"MYN ") }, // Mayan  [family]
    LangTag {
        language: "myq",
        tag: Tag::from_bytes(b"MNK "),
    }, // Forest Maninka(retired code) -> Maninka
    LangTag {
        language: "myv",
        tag: Tag::from_bytes(b"ERZ "),
    }, // Erzya
    //  LangTag { language: "mzn", 	tag: Tag::from_bytes(b"MZN ") }, // Mazanderani
    LangTag {
        language: "na",
        tag: Tag::from_bytes(b"NAU "),
    }, // Nauru -> Nauruan
    ...
    LangTag {
        language: "nan",
        tag: Tag::from_bytes(b"ZHS "),
    }, // Min Nan Chinese -> Chinese Simplified
    //  LangTag { language: "nap", 	tag: Tag::from_bytes(b"NAP ") }, // Neapolitan
    LangTag {
        language: "nb",
        tag: Tag::from_bytes(b"NOR "),
    }, // Norwegian Bokmål -> Norwegian
    LangTag {
        language: "nd",
        tag: Tag::from_bytes(b"NDB "),
    ...
    LangTag {
        language: "ng",
        tag: Tag::from_bytes(b"NDG "),
    }, // Ndonga
    //  LangTag { language: "nga", 	tag: Tag::from_bytes(b"NGA ") }, // Ngbaka
    LangTag {
        language: "ngl",
        tag: Tag::from_bytes(b"LMW "),
    }, // Lomwe
    LangTag {
        language: "ngo",
        tag: Tag::from_bytes(b"SXT "),
    }, // Ngoni -> Sutu
    LangTag {
        language: "nhd",
        tag: Tag::from_bytes(b"GUA "),
    ...
    LangTag {
        language: "nod",
        tag: Tag::from_bytes(b"NTA "),
    }, // Northern Thai -> Northern Tai
    ...
    LangTag {
        language: "nqo",
        tag: Tag::from_bytes(b"NKO "),
    }, // N’Ko
    LangTag {
        language: "nr",
        tag: Tag::from_bytes(b"NDB "),
    }, // South Ndebele -> Ndebele
    LangTag {
        language: "nsk",
        tag: Tag::from_bytes(b"NAS "),
    }, // Naskapi
    //  LangTag { language: "nso", 	tag: Tag::from_bytes(b"NSO ") }, // Pedi -> Sotho, Northern
    LangTag {
        language: "nv",
        tag: Tag::from_bytes(b"NAV "),
    }, // Navajo
    LangTag {
        language: "nv",
        tag: Tag::from_bytes(b"ATH "),
    ...
    LangTag {
        language: "nyn",
        tag: Tag::from_bytes(b"NKL "),
    }, // Nyankole
    //  LangTag { language: "nza", 	tag: Tag::from_bytes(b"NZA ") }, // Tigon Mbembe -> Mbembe Tigon
    LangTag {
        language: "oc",
        tag: Tag::from_bytes(b"OCI "),
    }, // Occitan (post 1500)
    LangTag {
        language: "oj",
        tag: Tag::from_bytes(b"OJB "),
    }, // Ojibwa [macrolanguage] -> Ojibway
    //  LangTag { language: "ojb", 	tag: Tag::from_bytes(b"OJB ") }, // Northwestern Ojibwa -> Ojibway
    LangTag {
        language: "ojc",
        tag: Tag::from_bytes(b"OJB "),
    }, // Central Ojibwa -> Ojibway
    LangTag {
        language: "ojg",
        tag: Tag::from_bytes(b"OJB "),
    }, // Eastern Ojibwa -> Ojibway
    LangTag {
        language: "ojs",
        tag: Tag::from_bytes(b"OCR "),
    }, // Severn Ojibwa -> Oji-Cree
    LangTag {
        language: "ojw",
        tag: Tag::from_bytes(b"OJB "),
    }, // Western Ojibwa -> Ojibway
    LangTag {
        language: "oki",
        tag: Tag::from_bytes(b"KAL "),
    }, // Okiek -> Kalenjin
    LangTag {
        language: "okm",
        tag: Tag::from_bytes(b"KOH "),
    }, // Middle Korean (10th-16th cent.) -> Korean Old Hangul
    LangTag {
        language: "om",
        tag: Tag::from_bytes(b"ORO "),
    }, // Oromo [macrolanguage]
    LangTag {
        language: "or",
        tag: Tag::from_bytes(b"ORI "),
    }, // Odia (formerly Oriya) [macrolanguage]
    LangTag {
        language: "orc",
        tag: Tag::from_bytes(b"ORO "),
    }, // Orma -> Oromo
    ...
    LangTag {
        language: "pce",
        tag: Tag::from_bytes(b"PLG "),
    }, // Ruching Palaung -> Palaung
    LangTag {
        language: "pck",
        tag: Tag::from_bytes(b"QIN "),
    }, // Paite Chin -> Chin
    ...
    LangTag {
        language: "pga",
        tag: Tag::from_bytes(b"ARA "),
    }, // Sudanese Creole Arabic -> Arabic
    //  LangTag { language: "phk", 	tag: Tag::from_bytes(b"PHK ") }, // Phake
    LangTag {
        language: "pi",
        tag: Tag::from_bytes(b"PAL "),
    }, // Pali
    ...
    LangTag {
        language: "pl",
        tag: Tag::from_bytes(b"PLK "),
    }, // Polish
    LangTag {
        language: "pll",
        tag: Tag::from_bytes(b"PLG "),
    }, // Shwe Palaung -> Palaung
    LangTag {
        language: "plp",
        tag: Tag::from_bytes(b"PAP "),
    }, // Palpa
    LangTag {
        language: "plt",
        tag: Tag::from_bytes(b"MLG "),
    ...
    LangTag {
        language: "pt",
        tag: Tag::from_bytes(b"PTG "),
    }, // Portuguese
    //  LangTag { language: "pwo", 	tag: Tag::from_bytes(b"PWO ") }, // Pwo Western Karen -> Western Pwo Karen
    LangTag {
        language: "qu",
        tag: Tag::from_bytes(b"QUZ "),
    }, // Quechua [macrolanguage]
    LangTag {
        language: "qub",
        tag: Tag::from_bytes(b"QWH "),
    }, // Huallaga Huánuco Quechua -> Quechua (Peru)
    //  LangTag { language: "quc", 	tag: Tag::from_bytes(b"QUC ") }, // K’iche’
    LangTag {
        language: "qud",
        tag: Tag::from_bytes(b"QVI "),
    }, // Calderón Highland Quichua -> Quechua (Ecuador)
    LangTag {
        language: "quf",
        tag: Tag::from_bytes(b"QUZ "),
    }, // Lambayeque Quechua -> Quechua
    LangTag {
        language: "qug",
        tag: Tag::from_bytes(b"QVI "),
    }, // Chimborazo Highland Quichua -> Quechua (Ecuador)
    //  LangTag { language: "quh", 	tag: Tag::from_bytes(b"QUH ") }, // South Bolivian Quechua -> Quechua (Bolivia)
    LangTag {
        language: "quk",
        tag: Tag::from_bytes(b"QUZ "),
    }, // Chachapoyas Quechua -> Quechua
    LangTag {
        language: "qul",
        tag: Tag::from_bytes(b"QUZ "),
    ...
    LangTag {
        language: "qup",
        tag: Tag::from_bytes(b"QVI "),
    }, // Southern Pastaza Quechua -> Quechua (Ecuador)
    LangTag {
        language: "qur",
        tag: Tag::from_bytes(b"QWH "),
    }, // Yanahuanca Pasco Quechua -> Quechua (Peru)
    LangTag {
        language: "qus",
        tag: Tag::from_bytes(b"QUH "),
    }, // Santiago del Estero Quichua -> Quechua (Bolivia)
    LangTag {
        language: "quw",
        tag: Tag::from_bytes(b"QVI "),
    }, // Tena Lowland Quichua -> Quechua (Ecuador)
    LangTag {
        language: "qux",
        tag: Tag::from_bytes(b"QWH "),
    }, // Yauyos Quechua -> Quechua (Peru)
    LangTag {
        language: "quy",
        tag: Tag::from_bytes(b"QUZ "),
    ...
    LangTag {
        language: "qva",
        tag: Tag::from_bytes(b"QWH "),
    }, // Ambo-Pasco Quechua -> Quechua (Peru)
    LangTag {
        language: "qvc",
        tag: Tag::from_bytes(b"QUZ "),
    }, // Cajamarca Quechua -> Quechua
    LangTag {
        language: "qve",
        tag: Tag::from_bytes(b"QUZ "),
    ...
    LangTag {
        language: "qvh",
        tag: Tag::from_bytes(b"QWH "),
    }, // Huamalíes-Dos de Mayo Huánuco Quechua -> Quechua (Peru)
    //  LangTag { language: "qvi", 	tag: Tag::from_bytes(b"QVI ") }, // Imbabura Highland Quichua -> Quechua (Ecuador)
    LangTag {
        language: "qvj",
        tag: Tag::from_bytes(b"QVI "),
    }, // Loja Highland Quichua -> Quechua (Ecuador)
    LangTag {
        language: "qvl",
        tag: Tag::from_bytes(b"QWH "),
    }, // Cajatambo North Lima Quechua -> Quechua (Peru)
    LangTag {
        language: "qvm",
        tag: Tag::from_bytes(b"QWH "),
    }, // Margos-Yarowilca-Lauricocha Quechua -> Quechua (Peru)
    LangTag {
        language: "qvn",
        tag: Tag::from_bytes(b"QWH "),
    }, // North Junín Quechua -> Quechua (Peru)
    LangTag {
        language: "qvo",
        tag: Tag::from_bytes(b"QVI "),
    }, // Napo Lowland Quechua -> Quechua (Ecuador)
    LangTag {
        language: "qvp",
        tag: Tag::from_bytes(b"QWH "),
    }, // Pacaraos Quechua -> Quechua (Peru)
    LangTag {
        language: "qvs",
        tag: Tag::from_bytes(b"QUZ "),
    }, // San Martín Quechua -> Quechua
    LangTag {
        language: "qvw",
        tag: Tag::from_bytes(b"QWH "),
    }, // Huaylla Wanca Quechua -> Quechua (Peru)
    LangTag {
        language: "qvz",
        tag: Tag::from_bytes(b"QVI "),
    }, // Northern Pastaza Quichua -> Quechua (Ecuador)
    LangTag {
        language: "qwa",
        tag: Tag::from_bytes(b"QWH "),
    }, // Corongo Ancash Quechua -> Quechua (Peru)
    LangTag {
        language: "qwc",
        tag: Tag::from_bytes(b"QUZ "),
    ...
    LangTag {
        language: "qws",
        tag: Tag::from_bytes(b"QWH "),
    }, // Sihuas Ancash Quechua -> Quechua (Peru)
    LangTag {
        language: "qxa",
        tag: Tag::from_bytes(b"QWH "),
    }, // Chiquián Ancash Quechua -> Quechua (Peru)
    LangTag {
        language: "qxc",
        tag: Tag::from_bytes(b"QWH "),
    }, // Chincha Quechua -> Quechua (Peru)
    LangTag {
        language: "qxh",
        tag: Tag::from_bytes(b"QWH "),
    }, // Panao Huánuco Quechua -> Quechua (Peru)
    LangTag {
        language: "qxl",
        tag: Tag::from_bytes(b"QVI "),
    }, // Salasaca Highland Quichua -> Quechua (Ecuador)
    LangTag {
        language: "qxn",
        tag: Tag::from_bytes(b"QWH "),
    }, // Northern Conchucos Ancash Quechua -> Quechua (Peru)
    LangTag {
        language: "qxo",
        tag: Tag::from_bytes(b"QWH "),
    }, // Southern Conchucos Ancash Quechua -> Quechua (Peru)
    LangTag {
        language: "qxp",
        tag: Tag::from_bytes(b"QUZ "),
    }, // Puno Quechua -> Quechua
    LangTag {
        language: "qxr",
        tag: Tag::from_bytes(b"QVI "),
    }, // Cañar Highland Quichua -> Quechua (Ecuador)
    LangTag {
        language: "qxt",
        tag: Tag::from_bytes(b"QWH "),
    }, // Santa Ana de Tusi Pasco Quechua -> Quechua (Peru)
    LangTag {
        language: "qxu",
        tag: Tag::from_bytes(b"QUZ "),
    }, // Arequipa-La Unión Quechua -> Quechua
    LangTag {
        language: "qxw",
        tag: Tag::from_bytes(b"QWH "),
    }, // Jauja Wanca Quechua -> Quechua (Peru)
    LangTag {
        language: "rag",
        tag: Tag::from_bytes(b"LUH "),
    }, // Logooli -> Luyia
    ...
    LangTag {
        language: "rm",
        tag: Tag::from_bytes(b"RMS "),
    }, // Romansh
    LangTag {
        language: "rmc",
        tag: Tag::from_bytes(b"ROY "),
    }, // Carpathian Romani -> Romany
    LangTag {
        language: "rmf",
        tag: Tag::from_bytes(b"ROY "),
    }, // Kalo Finnish Romani -> Romany
    LangTag {
        language: "rml",
        tag: Tag::from_bytes(b"ROY "),
    }, // Baltic Romani -> Romany
    LangTag {
        language: "rmn",
        tag: Tag::from_bytes(b"ROY "),
    }, // Balkan Romani -> Romany
    LangTag {
        language: "rmo",
        tag: Tag::from_bytes(b"ROY "),
    }, // Sinte Romani -> Romany
    ...
    LangTag {
        language: "rn",
        tag: Tag::from_bytes(b"RUN "),
    }, // Rundi
    LangTag {
        language: "rnl",
        tag: Tag::from_bytes(b"HAL "),
    }, // Ranglong -> Halam (Falam Chin)
    LangTag {
        language: "ro",
        tag: Tag::from_bytes(b"ROM "),
    }, // Romanian
    LangTag {
        language: "rom",
        tag: Tag::from_bytes(b"ROY "),
    ...
    LangTag {
        language: "ru",
        tag: Tag::from_bytes(b"RUS "),
    }, // Russian
    LangTag {
        language: "rue",
        tag: Tag::from_bytes(b"RSY "),
    }, // Rusyn
    //  LangTag { language: "rup", 	tag: Tag::from_bytes(b"RUP ") }, // Aromanian
    LangTag {
        language: "rw",
        tag: Tag::from_bytes(b"RUA "),
    }, // Kinyarwanda
    LangTag {
        language: "rwr",
        tag: Tag::from_bytes(b"MAW "),
    ...
    LangTag {
        language: "scs",
        tag: Tag::from_bytes(b"ATH "),
    }, // North Slavey -> Athapaskan
    LangTag {
        language: "sd",
        tag: Tag::from_bytes(b"SND "),
    }, // Sindhi
    LangTag {
        language: "sdc",
        tag: Tag::from_bytes(b"SRD "),
    }, // Sassarese Sardinian -> Sardinian
    LangTag {
        language: "sdh",
        tag: Tag::from_bytes(b"KUR "),
    ...
    LangTag {
        language: "sdn",
        tag: Tag::from_bytes(b"SRD "),
    }, // Gallurese Sardinian -> Sardinian
    LangTag {
        language: "se",
        tag: Tag::from_bytes(b"NSM "),
    }, // Northern Sami
    LangTag {
        language: "seh",
        tag: Tag::from_bytes(b"SNA "),
    }, // Sena
    LangTag {
        language: "sek",
        tag: Tag::from_bytes(b"ATH "),
    ...
    LangTag {
        language: "sfm",
        tag: Tag::from_bytes(b"HMN "),
    }, // Small Flowery Miao -> Hmong
    LangTag {
        language: "sg",
        tag: Tag::from_bytes(b"SGO "),
    }, // Sango
    ...
    LangTag {
        language: "sgw",
        tag: Tag::from_bytes(b"CHG "),
    }, // Sebat Bet Gurage -> Chaha Gurage
    LangTag {
        language: "sgw",
        tag: Tag::from_bytes(b"SGW "),
    }, // Sebat Bet Gurage -> Chaha Gurage(SIL fonts)
    ...
    LangTag {
        language: "si",
        tag: Tag::from_bytes(b"SNH "),
    }, // Sinhala (Sinhalese)
    //  LangTag { language: "sid", 	tag: Tag::from_bytes(b"SID ") }, // Sidamo
    LangTag {
        language: "sjd",
        tag: Tag::from_bytes(b"KSM "),
    }, // Kildin Sami
    LangTag {
        language: "sjo",
        tag: Tag::from_bytes(b"SIB "),
    }, // Xibe -> Sibe
    LangTag {
        language: "sk",
        tag: Tag::from_bytes(b"SKY "),
    }, // Slovak
    LangTag {
        language: "skg",
        tag: Tag::from_bytes(b"MLG "),
    }, // Sakalava Malagasy -> Malagasy
    LangTag {
        language: "skr",
        tag: Tag::from_bytes(b"SRK "),
    }, // Saraiki
    LangTag {
        language: "sl",
        tag: Tag::from_bytes(b"SLV "),
    }, // Slovenian
    LangTag {
        language: "sm",
        tag: Tag::from_bytes(b"SMO "),
    }, // Samoan
    LangTag {
        language: "sma",
        tag: Tag::from_bytes(b"SSM "),
    }, // Southern Sami
    LangTag {
        language: "smj",
        tag: Tag::from_bytes(b"LSM "),
    }, // Lule Sami
    LangTag {
        language: "smn",
        tag: Tag::from_bytes(b"ISM "),
    }, // Inari Sami
    LangTag {
        language: "sms",
        tag: Tag::from_bytes(b"SKS "),
    }, // Skolt Sami
    LangTag {
        language: "sn",
        tag: Tag::from_bytes(b"SNA0"),
    }, // Shona
    //  LangTag { language: "snk", 	tag: Tag::from_bytes(b"SNK ") }, // Soninke
    LangTag {
        language: "so",
        tag: Tag::from_bytes(b"SML "),
    }, // Somali
    //  LangTag { language: "sop", 	tag: Tag::from_bytes(b"SOP ") }, // Songe
    LangTag {
        language: "spv",
        tag: Tag::from_bytes(b"ORI "),
    }, // Sambalpuri -> Odia (formerly Oriya)
    LangTag {
        language: "spy",
        tag: Tag::from_bytes(b"KAL "),
    }, // Sabaot -> Kalenjin
    ...
    LangTag {
        language: "sr",
        tag: Tag::from_bytes(b"SRB "),
    }, // Serbian
    LangTag {
        language: "src",
        tag: Tag::from_bytes(b"SRD "),
    }, // Logudorese Sardinian -> Sardinian
    LangTag {
        language: "sro",
        tag: Tag::from_bytes(b"SRD "),
    }, // Campidanese Sardinian -> Sardinian
    ...
    LangTag {
        language: "ss",
        tag: Tag::from_bytes(b"SWZ "),
    }, // Swati
    LangTag {
        language: "ssh",
        tag: Tag::from_bytes(b"ARA "),
    }, // Shihhi Arabic -> Arabic
    LangTag {
        language: "st",
        tag: Tag::from_bytes(b"SOT "),
    }, // Southern Sotho -> Sotho, Southern
    //  LangTag { language: "stq", 	tag: Tag::from_bytes(b"STQ ") }, // Saterfriesisch -> Saterland Frisian
    LangTag {
        language: "stv",
        tag: Tag::from_bytes(b"SIG "),
    }, // Silt'e -> Silte Gurage
    LangTag {
        language: "su",
        tag: Tag::from_bytes(b"SUN "),
    }, // Sundanese
    //  LangTag { language: "suk", 	tag: Tag::from_bytes(b"SUK ") }, // Sukuma
    LangTag {
        language: "suq",
        tag: Tag::from_bytes(b"SUR "),
    }, // Suri
    LangTag {
        language: "sv",
        tag: Tag::from_bytes(b"SVE "),
    }, // Swedish
    //  LangTag { language: "sva", 	tag: Tag::from_bytes(b"SVA ") }, // Svan
    LangTag {
        language: "sw",
        tag: Tag::from_bytes(b"SWK "),
    }, // Swahili  [macrolanguage]
    LangTag {
        language: "swb",
        tag: Tag::from_bytes(b"CMR "),
    }, // Maore Comorian -> Comorian
    LangTag {
        language: "swc",
        tag: Tag::from_bytes(b"SWK "),
    }, // Congo Swahili -> Swahili
    LangTag {
        language: "swh",
        tag: Tag::from_bytes(b"SWK "),
    }, // Swahili
    ...
    LangTag {
        language: "ta",
        tag: Tag::from_bytes(b"TAM "),
    }, // Tamil
    LangTag {
        language: "taa",
        tag: Tag::from_bytes(b"ATH "),
    }, // Lower Tanana -> Athapaskan
    //  LangTag { language: "tab", 	tag: Tag::from_bytes(b"TAB ") }, // Tabassaran -> Tabasaran
    LangTag {
        language: "taq",
        tag: Tag::from_bytes(b"TMH "),
    }, // Tamasheq -> Tamashek
    LangTag {
        language: "tau",
        tag: Tag::from_bytes(b"ATH "),
    }, // Upper Tanana -> Athapaskan
    LangTag {
        language: "tcb",
        tag: Tag::from_bytes(b"ATH "),
    }, // Tanacross -> Athapaskan
    LangTag {
        language: "tce",
        tag: Tag::from_bytes(b"ATH "),
    }, // Southern Tutchone -> Athapaskan
    LangTag {
        language: "tcp",
        tag: Tag::from_bytes(b"QIN "),
    }, // Tawr Chin -> Chin
    ...
    LangTag {
        language: "tdx",
        tag: Tag::from_bytes(b"MLG "),
    }, // Tandroy-Mahafaly Malagasy -> Malagasy
    LangTag {
        language: "te",
        tag: Tag::from_bytes(b"TEL "),
    }, // Telugu
    LangTag {
        language: "tec",
        tag: Tag::from_bytes(b"KAL "),
    ...
    LangTag {
        language: "thv",
        tag: Tag::from_bytes(b"TMH "),
    }, // Tahaggart Tamahaq -> Tamashek
    LangTag {
        language: "thz",
        tag: Tag::from_bytes(b"TMH "),
    }, // Tayart Tamajeq -> Tamashek
    LangTag {
        language: "ti",
        tag: Tag::from_bytes(b"TGY "),
    }, // Tigrinya
    LangTag {
        language: "tig",
        tag: Tag::from_bytes(b"TGR "),
    }, // Tigre
    //  LangTag { language: "tiv", 	tag: Tag::from_bytes(b"TIV ") }, // Tiv
    LangTag {
        language: "tk",
        tag: Tag::from_bytes(b"TKM "),
    }, // Turkmen
    LangTag {
        language: "tkg",
        tag: Tag::from_bytes(b"MLG "),
    }, // Tesaka Malagasy -> Malagasy
    LangTag {
        language: "tl",
        tag: Tag::from_bytes(b"TGL "),
    }, // Tagalog
    ...
    LangTag {
        language: "tn",
        tag: Tag::from_bytes(b"TNA "),
    }, // Tswana
    LangTag {
        language: "tnf",
        tag: Tag::from_bytes(b"DRI "),
    }, // Tangshewi(retired code) -> Dari
    LangTag {
        language: "to",
        tag: Tag::from_bytes(b"TGN "),
    }, // Tonga (Tonga Islands) -> Tongan
    LangTag {
        language: "tod",
        tag: Tag::from_bytes(b"TOD0"),
    }, // Toma
    LangTag {
        language: "toi",
        tag: Tag::from_bytes(b"TNG "),
    }, // Tonga (Zambia)
    LangTag {
        language: "tol",
        tag: Tag::from_bytes(b"ATH "),
    ...
    LangTag {
        language: "tr",
        tag: Tag::from_bytes(b"TRK "),
    }, // Turkish
    LangTag {
        language: "tru",
        tag: Tag::from_bytes(b"TUA "),
    }, // Turoyo -> Turoyo Aramaic
    LangTag {
        language: "tru",
        tag: Tag::from_bytes(b"SYR "),
    }, // Turoyo -> Syriac
    LangTag {
        language: "ts",
        tag: Tag::from_bytes(b"TSG "),
    }, // Tsonga
    //  LangTag { language: "tsj", 	tag: Tag::from_bytes(b"TSJ ") }, // Tshangla
    LangTag {
        language: "tt",
        tag: Tag::from_bytes(b"TAT "),
    }, // Tatar
    LangTag {
        language: "ttm",
        tag: Tag::from_bytes(b"ATH "),
    }, // Northern Tutchone -> Athapaskan
    LangTag {
        language: "ttq",
        tag: Tag::from_bytes(b"TMH "),
    }, // Tawallammat Tamajaq -> Tamashek
    ...
    LangTag {
        language: "txy",
        tag: Tag::from_bytes(b"MLG "),
    }, // Tanosy Malagasy -> Malagasy
    LangTag {
        language: "ty",
        tag: Tag::from_bytes(b"THT "),
    }, // Tahitian
    LangTag {
        language: "tyv",
        tag: Tag::from_bytes(b"TUV "),
    }, // Tuvinian -> Tuvin
    ...
    LangTag {
        language: "ubl",
        tag: Tag::from_bytes(b"BIK "),
    }, // Buhi'non Bikol -> Bikol
    //  LangTag { language: "udm", 	tag: Tag::from_bytes(b"UDM ") }, // Udmurt
    LangTag {
        language: "ug",
        tag: Tag::from_bytes(b"UYG "),
    }, // Uyghur
    LangTag {
        language: "uk",
        tag: Tag::from_bytes(b"UKR "),
    }, // Ukrainian
    //  LangTag { language: "umb", 	tag: Tag::from_bytes(b"UMB ") }, // Umbundu
    LangTag {
        language: "unr",
        tag: Tag::from_bytes(b"MUN "),
    }, // Mundari
    LangTag {
        language: "ur",
        tag: Tag::from_bytes(b"URD "),
    }, // Urdu
    LangTag {
        language: "urk",
        tag: Tag::from_bytes(b"MLY "),
    ...
    LangTag {
        language: "vkt",
        tag: Tag::from_bytes(b"MLY "),
    }, // Tenggarong Kutai Malay -> Malay
    LangTag {
        language: "vls",
        tag: Tag::from_bytes(b"FLE "),
    }, // Vlaams -> Dutch (Flemish)
    LangTag {
        language: "vmw",
        tag: Tag::from_bytes(b"MAK "),
    }, // Makhuwa
    LangTag {
        language: "vo",
        tag: Tag::from_bytes(b"VOL "),
    }, // Volapük
    //  LangTag { language: "vro", 	tag: Tag::from_bytes(b"VRO ") }, // Võro
    LangTag {
        language: "wa",
        tag: Tag::from_bytes(b"WLN "),
    }, // Walloon
    //  LangTag { language: "war", 	tag: Tag::from_bytes(b"WAR ") }, // Waray (Philippines) -> Waray-Waray
    LangTag {
        language: "wbm",
        tag: Tag::from_bytes(b"WA  "),
    }, // Wa
    LangTag {
        language: "wbr",
        tag: Tag::from_bytes(b"WAG "),
    }, // Wagdi
    LangTag {
        language: "wlc",
        tag: Tag::from_bytes(b"CMR "),
    }, // Mwali Comorian -> Comorian
    LangTag {
        language: "wle",
        tag: Tag::from_bytes(b"SIG "),
    }, // Wolane -> Silte Gurage
    ...
    LangTag {
        language: "wni",
        tag: Tag::from_bytes(b"CMR "),
    }, // Ndzwani Comorian -> Comorian
    LangTag {
        language: "wo",
        tag: Tag::from_bytes(b"WLF "),
    }, // Wolof
    LangTag {
        language: "wry",
        tag: Tag::from_bytes(b"MAW "),
    ...
    LangTag {
        language: "xal",
        tag: Tag::from_bytes(b"KLM "),
    }, // Kalmyk
    LangTag {
        language: "xal",
        tag: Tag::from_bytes(b"TOD "),
    }, // Kalmyk -> Todo
    LangTag {
        language: "xan",
        tag: Tag::from_bytes(b"SEK "),
    }, // Xamtanga -> Sekota
    LangTag {
        language: "xh",
        tag: Tag::from_bytes(b"XHS "),
    }, // Xhosa
    ...
    LangTag {
        language: "xmv",
        tag: Tag::from_bytes(b"MLG "),
    }, // Antankarana Malagasy -> Malagasy
    LangTag {
        language: "xmw",
        tag: Tag::from_bytes(b"MLG "),
    }, // Tsimihety Malagasy -> Malagasy
    LangTag {
        language: "xnr",
        tag: Tag::from_bytes(b"DGR "),
    }, // Kangri -> Dogri
    ...
    LangTag {
        language: "xst",
        tag: Tag::from_bytes(b"SIG "),
    }, // Silt'e(retired code) -> Silte Gurage
    LangTag {
        language: "xwo",
        tag: Tag::from_bytes(b"TOD "),
    }, // Written Oirat -> Todo
    ...
    LangTag {
        language: "ybd",
        tag: Tag::from_bytes(b"ARK "),
    }, // Yangbye(retired code) -> Rakhine
    LangTag {
        language: "ydd",
        tag: Tag::from_bytes(b"JII "),
    }, // Eastern Yiddish -> Yiddish
    LangTag {
        language: "yi",
        tag: Tag::from_bytes(b"JII "),
    }, // Yiddish [macrolanguage]
    LangTag {
        language: "yih",
        tag: Tag::from_bytes(b"JII "),
    }, // Western Yiddish -> Yiddish
    LangTag {
        language: "yo",
        tag: Tag::from_bytes(b"YBA "),
    }, // Yoruba
    LangTag {
        language: "yos",
        tag: Tag::from_bytes(b"QIN "),
    }, // Yos(retired code) -> Chin
    LangTag {
        language: "yrk",
        tag: Tag::from_bytes(b"TNE "),
    ...
    LangTag {
        language: "yue",
        tag: Tag::from_bytes(b"ZHH "),
    }, // Yue Chinese -> Chinese, Hong Kong SAR
    LangTag {
        language: "za",
        tag: Tag::from_bytes(b"ZHA "),
    }, // Zhuang [macrolanguage]
    LangTag {
        language: "zch",
        tag: Tag::from_bytes(b"ZHA "),
    }, // Central Hongshuihe Zhuang -> Zhuang
    LangTag {
        language: "zdj",
        tag: Tag::from_bytes(b"CMR "),
    }, // Ngazidja Comorian -> Comorian
    //  LangTag { language: "zea", 	tag: Tag::from_bytes(b"ZEA ") }, // Zeeuws -> Zealandic
    LangTag {
        language: "zeh",
        tag: Tag::from_bytes(b"ZHA "),
    }, // Eastern Hongshuihe Zhuang -> Zhuang
    LangTag {
        language: "zgb",
        tag: Tag::from_bytes(b"ZHA "),
    }, // Guibei Zhuang -> Zhuang
    ...
    LangTag {
        language: "zgn",
        tag: Tag::from_bytes(b"ZHA "),
    }, // Guibian Zhuang -> Zhuang
    LangTag {
        language: "zh",
        tag: Tag::from_bytes(b"ZHS "),
    }, // Chinese [macrolanguage] -> Chinese Simplified
    LangTag {
        language: "zhd",
        tag: Tag::from_bytes(b"ZHA "),
    }, // Dai Zhuang -> Zhuang
    ...
    LangTag {
        language: "zln",
        tag: Tag::from_bytes(b"ZHA "),
    }, // Lianshan Zhuang -> Zhuang
    LangTag {
        language: "zlq",
        tag: Tag::from_bytes(b"ZHA "),
    }, // Liuqian Zhuang -> Zhuang
    LangTag {
        language: "zmi",
        tag: Tag::from_bytes(b"MLY "),
    }, // Negeri Sembilan Malay -> Malay
    LangTag {
        language: "zne",
        tag: Tag::from_bytes(b"ZND "),
    }, // Zande
    LangTag {
        language: "zom",
        tag: Tag::from_bytes(b"QIN "),
