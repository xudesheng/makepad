...
fn matra_position_indic(u: u32, side: u8) -> u8 {
    #[inline]
    fn in_half_block(u: u32, base: u32) -> bool {
        u & !0x7F == base
    }
    #[inline]
    fn is_deva(u: u32) -> bool {
        in_half_block(u, 0x0900)
    }
    #[inline]
    fn is_beng(u: u32) -> bool {
        in_half_block(u, 0x0980)
    }
    #[inline]
    fn is_guru(u: u32) -> bool {
        in_half_block(u, 0x0A00)
    }
    #[inline]
    fn is_gujr(u: u32) -> bool {
        in_half_block(u, 0x0A80)
    }
    #[inline]
    fn is_orya(u: u32) -> bool {
        in_half_block(u, 0x0B00)
    }
    #[inline]
    fn is_taml(u: u32) -> bool {
        in_half_block(u, 0x0B80)
    }
    #[inline]
    fn is_telu(u: u32) -> bool {
        in_half_block(u, 0x0C00)
    }
    #[inline]
    fn is_knda(u: u32) -> bool {
        in_half_block(u, 0x0C80)
    }
    #[inline]
    fn is_mlym(u: u32) -> bool {
        in_half_block(u, 0x0D00)
    }
    #[inline]
    fn is_sinh(u: u32) -> bool {
