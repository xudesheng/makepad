...
pub struct DrawFlowBlock {
    ...
    pub code_color: Vec4,
    #[live]
    pub quote_bg_color: Vec4,
    #[live]
    pub quote_fg_color: Vec4,
    #[live]
    ...
    pub fn begin_list_item(&mut self, cx: &mut Cx2d, dot: &str, pad: f64) {
        ...
        let pos = match marker_len {
            ...
            _ => {
                ...
                let pad =
                    pad + self.draw_normal.text_style.font_size as f64 * (marker_len - 2) as f64;
...
struct TextFlowLink {
    ...
    #[live]
    color_hover: Option<Vec4>,
    /// The font color used when the link is down.
    #[live]
    color_down: Option<Vec4>,
