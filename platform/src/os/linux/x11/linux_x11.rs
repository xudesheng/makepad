use {
    self::super::super::{
        egl_sys, gl_sys::LibGl, linux_media::CxLinuxMedia, x11::x11_sys, x11::xlib_app::*,
        x11::xlib_event::*,
    },
    self::super::opengl_x11::{OpenglCx, OpenglWindow},
    crate::{
...
impl Cx {
    ...
    fn xlib_event_callback(
        ...
        match event {
            ...
            XlibEvent::Scroll(e) => self.call_event_handler(&Event::Scroll(e.into())),
            XlibEvent::WindowDragQuery(e) => self.call_event_handler(&Event::WindowDragQuery(e)),
            XlibEvent::WindowCloseRequested(e) => {
                self.call_event_handler(&Event::WindowCloseRequested(e))
            }
            XlibEvent::TextInput(e) => self.call_event_handler(&Event::TextInput(e)),
            XlibEvent::Drag(e) => self.call_event_handler(&Event::Drag(e)),
            XlibEvent::Drop(e) => self.call_event_handler(&Event::Drop(e)),
            XlibEvent::DragEnd => self.call_event_handler(&Event::DragEnd),
            XlibEvent::KeyDown(e) => {
            ...
            XlibEvent::TextCopy(e) => self.call_event_handler(&Event::TextCopy(e)),
            XlibEvent::TextCut(e) => self.call_event_handler(&Event::TextCut(e)),
            XlibEvent::Timer(e) => {
