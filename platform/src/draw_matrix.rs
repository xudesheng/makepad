#![allow(dead_code)]
use crate::{id_pool::*, makepad_math::Mat4};
...
impl DrawMatrix {
    pub fn id(&self) -> DrawMatrixId {
        DrawMatrixId(self.0.id, self.0.generation)
    }
...
impl std::ops::Index<DrawMatrixId> for CxDrawMatrixPool {
    ...
    fn index(&self, index: DrawMatrixId) -> &Self::Output {
        ...
        if d.generation != index.1 {
            error!(
                "MatrixNode id generation wrong {} {} {}",
