use crate::{
    ...
    icon_atlas::{CxIconArgs, CxIconAtlas},
    makepad_platform::*,
    turtle::{Size, Walk},
};
...
impl DrawIcon {
    ...
    pub fn draw_walk(&mut self, cx: &mut Cx2d, mut walk: Walk) {
        ...
        if let Some((path_hash, bounds)) =
            icon_atlas.get_icon_bounds(cx, &self.svg_path.as_arc(), self.svg_file.as_ref())
        {
            ...
            let slot = icon_atlas.get_icon_slot(
                CxIconArgs {
